...
if [[ -n "$VOICE_FIXTURE" ]]; then
  ...
  BRIDGE_EXTRA_ENV+=(
    ...
    "FLYWHEEL_VOICE_ENGINE=${FLYWHEEL_VOICE_ENGINE:-}"
    "FLYWHEEL_VOICE_EDGE_TTS_STREAM_CMD=${FLYWHEEL_VOICE_EDGE_TTS_STREAM_CMD:-}"
    "FLYWHEEL_HEADPHONE_BACKGROUND_ENABLED=${FLYWHEEL_HEADPHONE_BACKGROUND_ENABLED:-}"
  )
  LEAD_EXTRA_ENV+=(
