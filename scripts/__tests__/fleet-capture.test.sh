...
CASS_BOT_TOKEN=QAFAKE_NOT_A_TOKEN_836
PETER_BOT_TOKEN=QAFAKE_NOT_A_TOKEN_836
OPENAI_API_KEY=QAFAKE_NOT_A_KEY_836
TEAMLEAD_PORT=9876
EOF
...
rm -rf "$OUT"
inject_leak 'QAFAKE_NOT_A_KEY_836'
run_capture
if [ "$CAP_RC" -ne 0 ]; then
...
printf 'leftover token: QAFAKE_NOT_A_KEY_836\n' > "$OUT/stale-leak.txt"
run_capture
if [ "$CAP_RC" -ne 0 ]; then
