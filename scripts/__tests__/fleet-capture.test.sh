...
CASS_BOT_TOKEN=QASANDBOXFAKE_NOT_A_REAL_TOKEN_0000000000
PETER_BOT_TOKEN=QASANDBOXFAKE_NOT_A_REAL_TOKEN_1111111111
OPENAI_API_KEY=qasandboxfake-not-a-real-openai-key-000000
TEAMLEAD_PORT=9876
EOF
