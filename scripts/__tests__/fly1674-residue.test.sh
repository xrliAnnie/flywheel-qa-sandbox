...
allowed_hits=(
  ...
  # FLY-2654 reads the current TURN projection to prove every affected execution
  # is parked before a closeout restart; keep the production read and fixture exact.
  'packages/teamlead/src/bin/restart-request.ts|three_stage_turn'
  'packages/teamlead/src/bin/restart-scope.test.ts|three_stage_turn'
