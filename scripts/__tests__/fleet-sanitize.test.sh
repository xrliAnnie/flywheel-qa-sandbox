...
export OPENAI_API_KEY=QA_SCRATCH_NOT_A_TOKEN_4
...
check_flag  "S5b-json-bare-sk: JSON key with bare sk- value" \
  '{"openaiKey": "QA_SCRATCH_NOT_A_TOKEN_4"}'
