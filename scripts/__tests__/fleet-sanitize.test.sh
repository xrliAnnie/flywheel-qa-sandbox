...
export OPENAI_API_KEY=qasandboxfake-not-a-real-openai-key-000000
...
check_flag  "S1-discord: bare Discord bot token" \
  'QASANDBOXFAKE_NOT_A_REAL_TOKEN_2222222222'
check_flag  "S1-slack: bare xoxb- token" \
  'QASANDBOXFAKE-NOT-A-REAL-SLACK-TOKEN'
check_flag  "S1-openai: bare sk- token (Tadashi)" \
  'qasandboxfake-not-a-real-openai-key-111111'
...
check_flag  "S5b-json-bare-sk: JSON key with bare sk- value" \
  '{"openaiKey": "qasandboxfake-not-a-real-openai-key-111111"}'
