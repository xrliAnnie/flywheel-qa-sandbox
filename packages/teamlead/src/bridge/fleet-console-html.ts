...
.workspace{min-width:0;display:grid;grid-template-rows:minmax(0,1fr);overflow:hidden}.page{height:100%;display:none}.page.active{display:grid}.instances{grid-template-columns:280px minmax(0,1fr)}.project-rail{background:#fff;border-right:1px solid var(--line);padding:18px;overflow:auto}.search{width:100%;border:1px solid var(--line);border-radius:9px;padding:9px 11px;background:var(--wash);margin-bottom:16px}.group-title{font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);margin:15px 7px 6px}.project-button{width:100%;border:0;background:transparent;text-align:left;padding:10px;border-radius:9px;cursor:pointer;display:flex;justify-content:space-between;gap:8px}.project-button.active{background:var(--blue-wash);color:#064d9f}.project-name{overflow:hidden;text-overflow:ellipsis}.badge{display:inline-block;padding:2px 7px;border-radius:20px;background:#ececf1;color:#555;font-size:11px;white-space:nowrap}
