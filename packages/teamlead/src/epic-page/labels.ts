const LABELS = {
	...
	"attention.count_unlinked": "要你看 {n} 件，其中 {m} 件缺讨论串链接",
	"attention.unlinked": "其中 {n} 件缺讨论串链接",
	"attention.no_link": "（无讨论串链接）",
	"attention.no_link_reason": "（无讨论串链接：{reason}）",
	...
	"section.waiting_lead": "在等 Lead 的",
	"attention.older_questions": "另有 {n} 条较早问题",
	"lead_note.empty": "（Lead 尚未写判断）",
	...
	"page.scope_rule_note_v3": "已获 founder 裁定的规则 scope.v3",
