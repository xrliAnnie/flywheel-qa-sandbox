...
const founderVocabulary = {
	...
	"section.epics_count": "{n} 个(全做完的不列;Linear 状态单列;在跑按机器会话)",
	...
	"child.live": "在跑",
	"child.stopped_acceptance": "停着·等验收",
	"child.stopped_stuck": "停着·卡住",
	"child.stopped_stuck_no_heartbeat": "停着·卡住（起跑后无心跳）",
	"child.evidence_gap": "执行证据不足·说不准",
	"child.evidence_starting": "刚起跑·说不准",
	...
	"progress.stopped_acceptance": "没有机器在动·等验收",
	"progress.stopped_acceptance_other_live_session":
		"当前节点停着·另有会话活着·等验收",
	"progress.stopped_stuck": "没有机器在动·卡住",
	"progress.stopped_stuck.run_held": "流程被 held·请看 land 重试耗尽·卡住",
	"progress.stopped_stuck.run_held_other_live_session":
		"流程被 held·请看 land 重试耗尽·卡住·另有会话活着",
	"progress.stopped_stuck.declared_blocked": "IC 已声明卡住",
	"progress.stopped_stuck.declared_blocked_other_live_session":
		"IC 已声明卡住·另有会话活着",
	"progress.stopped_stuck.runner_stopped": "runner 已停机·卡住",
	"progress.stopped_stuck.runner_stopped_other_live_session":
		"runner 已停机·卡住·另有会话活着",
	"progress.stopped_stuck_no_heartbeat": "起跑后从未发出心跳·卡住",
	"progress.evidence_gap.heartbeat_stale": "账面未收尾·心跳过期·说不准",
	"progress.evidence_gap.heartbeat_missing": "账面未收尾·心跳缺失·说不准",
	"progress.evidence_gap.awaiting_first_heartbeat":
		"刚起跑·等第一次心跳·说不准",
	"progress.evidence_gap.facts_missing": "执行事实不足·说不准",
	...
	"view.order_desc":
		"Epic 按 Linear 状态分组、组内按单号;子单 在跑 → 停着 → 说不准 → 等依赖 → 可起跑 → 未开始、组内按单号",
