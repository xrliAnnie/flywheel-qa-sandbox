...
def record(direction,value):
    ...
    row={"at":time.strftime("%Y-%m-%dT%H:%M:%SZ",time.gmtime()),"monotonicMs":round(time.monotonic()*1000,3),"direction":direction,"message":safe(value)}
