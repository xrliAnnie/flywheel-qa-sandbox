...
svgs = {
    "__SVG_D1__": "d1-contract-flow.svg",
    "__SVG_D2__": "d2-data-model.svg",
    "__SVG_D3__": "d3-worker-lifecycle.svg",
    "__SVG_D4__": "d4-hold-front-door.svg",
}
...
for ph, fn in svgs.items():
    ...
    assert m and m.group(1) == "FLY-2248-" + ph[6:8].lower(), (fn, m and m.group(1))
