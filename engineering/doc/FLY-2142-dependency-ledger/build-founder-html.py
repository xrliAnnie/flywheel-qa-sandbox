...
diagram lost its <svg id="FLY-2142-dN"> root — never ship a visual artifact you did not
...
for n, name in diagrams.items():
    ...
    if f'id="FLY-2142-d{n}"' not in svg:
        sys.exit(f"diagram {name} lacks svgId FLY-2142-d{n}")
