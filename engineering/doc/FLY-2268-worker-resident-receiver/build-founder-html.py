...
svgs = {
    "__SVG_D1__": "d1-worker-lifecycle.svg",
    "__SVG_D2__": "d2-data-model.svg",
    "__SVG_D3__": "d3-expiry-saga.svg",
    "__SVG_D4__": "d4-drain-challenge.svg",
}
...
for ph, fn in svgs.items():
    ...
    assert m and m.group(1) == "FLY-2268-" + ph[6:8].lower(), (fn, m and m.group(1))
