...
assert.equal(f.saved.get('flywheel:design-comments:/test/one:summary'), '想看学习的边界');
...
console.log('PASS: artifact shape, 8 section comments, one nonce script, no external assets/tables/inline handlers, pathname storage, live summary, 1800-character Unicode chunks, clipboard success/rejection/absence/failure, storage denied, clear/reload isolation.');
