...
本调研是对 `doc/exploration/new/v0.2-trending-repo-survey.md`（2026-03-01，13 个 trending repos）的**补充调研**。前次 survey 覆盖了 superset-ai（worktree + hook 代码直接移植）、ruflo（session forking）、markitdown（附件预处理）等直接可用的工具。
