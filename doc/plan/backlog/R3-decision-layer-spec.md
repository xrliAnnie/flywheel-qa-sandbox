...
> 输入：`doc/research/new/006-decision-layer-patterns.md`
> 预期产出：`doc/exploration/new/v0.2-decision-layer.md`
...
### 主要文件
- `doc/exploration/new/v0.2-decision-layer.md` — 完整的 Decision Layer 设计
...
- `doc/research/new/006-decision-layer-patterns.md`（已有研究摘要）
