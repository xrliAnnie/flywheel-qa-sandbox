...
**Issue**: GEO-195
**Date**: 2026-03-21
**Source**: `doc/engineer/exploration/new/GEO-195-claude-discord-plugin.md`, `doc/engineer/research/new/GEO-195-claude-discord-plugin.md`
...
**Post-MVP ForumManager 设计见**: `doc/engineer/exploration/new/GEO-195-claude-discord-plugin.md` § Forum thread/tag 管理
