...
> 优先级：🟡 Medium
> 影响 Phase：v0.2
> 输入：`doc/engineer/exploration/new/v0.2-trending-repo-survey.md`（claude-scientific-skills 部分）
> 预期产出：`doc/engineer/exploration/new/v0.2-skill-system.md`
...
### 主要文件
- `doc/engineer/exploration/new/v0.2-skill-system.md` — Skill 注入系统设计
...
- `doc/engineer/exploration/new/v0.2-trending-repo-survey.md`（survey 中 skill 部分）
