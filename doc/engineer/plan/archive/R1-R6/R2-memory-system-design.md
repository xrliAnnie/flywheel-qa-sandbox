...
> 输入：`doc/engineer/research/new/005-memory-architecture-survey.md`
> 预期产出：`doc/engineer/exploration/new/v0.3-memory-system.md`
...
### 主要文件
- `doc/engineer/exploration/new/v0.3-memory-system.md` — 完整的记忆系统设计
...
- `doc/engineer/research/new/005-memory-architecture-survey.md`（已有研究摘要）
- `/tmp/memU/`（已 clone）
