...
| **Plan 路径** | `product/doc/{domain}/plan/new/` | `doc/engineer/plan/new/` |
| **Exploration/Research** | `product/doc/{domain}/exploration/new/` | `doc/engineer/exploration/new/`, `doc/engineer/research/new/` |
...
PLAN_NEW → doc/engineer/plan/new/          (唯一 plan 入口)
PLAN_INPROGRESS → doc/engineer/plan/inprogress/
PLAN_ARCHIVE → doc/engineer/plan/archive/
EXPLORATION_NEW → doc/engineer/exploration/new/
RESEARCH_NEW → doc/engineer/research/new/
...
### Q3: Plan 发现 — 扫描 `doc/engineer/plan/new/` 还是 Linear？

**建议: 扫描 `doc/engineer/plan/new/`（和 GeoForge3D 一致）。**
