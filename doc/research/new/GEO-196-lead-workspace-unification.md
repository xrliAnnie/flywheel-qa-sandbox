...
**Issue**: GEO-196
**Date**: 2026-03-20
**Source**: `doc/exploration/new/GEO-196-lead-workspace-unification.md`
...
- **Status**: codex-approved plan in `doc/plan/new/`
...
- **Active docs**: `doc/research/new/GEO-198-*`, `doc/plan/draft/v1.5.0-GEO-198-*`
...
- `doc/exploration/archive/GEO-167-*`
- `doc/plan/archive/v1.0-phase1-lead-mvp.md`
- `doc/plan/archive/v1.3.0-GEO-167-*`
- `doc/plan/archive/v0.5-step1-openclaw-bridge.md`
- `doc/plan/archive/v1.2.0-GEO-163-*`
- `doc/research/archive/v0.5-openclaw-pivot-codebase-research.md`
