...
**Issue**: GEO-280
**Date**: 2026-03-28
**Source**: `doc/exploration/new/GEO-280-sprint-closing.md`
...
- Exploration: `doc/exploration/new/GEO-{XX}-*.md` → `doc/exploration/archive/`
- Research: `doc/research/new/GEO-{XX}-*.md` → `doc/research/archive/`
- Plan: `doc/plan/inprogress/v*-GEO-{XX}-*.md` → `doc/plan/archive/`
