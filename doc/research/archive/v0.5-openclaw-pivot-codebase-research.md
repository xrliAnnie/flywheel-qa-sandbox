...
**Exploration**: `doc/exploration/new/v0.5-openclaw-pivot.md`
**Date**: 2026-03-06
**Status**: complete
...
| 文档 | 路径 | 用途 |
|------|------|------|
| OpenClaw Pivot 设计 | `doc/exploration/new/v0.5-openclaw-pivot.md` | 架构决策 + 用户确认 |
| Symphony Patterns | `doc/exploration/new/v0.5-symphony-patterns.md` | 12 个可借鉴模式 |
| steipete 生态 | `doc/exploration/new/v0.5-steipete-ecosystem.md` | 工具集成评估 |

### 间接参考（已归档但仍有价值）

| 文档 | 路径 | 提供的价值 |
|------|------|-----------|
| v0.4 TeamLead 设计 | `doc/exploration/archive/v0.4-teamlead-agent.md` | 组件设计原始思路 |
| v0.2 Decision Layer | `doc/exploration/archive/v0.2-decision-layer.md` | CIPHER 决策逻辑参考 |
| v0.4 Step 1 计划 | `doc/plan/draft/v0.4-step1-teamlead-agent.md` | 现有实现的详细设计 |
