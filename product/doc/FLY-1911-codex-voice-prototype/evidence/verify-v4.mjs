...
const p=spawn(CH,["--headless=new","--remote-debugging-port=9341","--no-sandbox","--autoplay-policy=no-user-gesture-required","about:blank"]);
...
o.stored = await ev("localStorage.getItem('fly1911c:q1')");
// 复制成功路径
