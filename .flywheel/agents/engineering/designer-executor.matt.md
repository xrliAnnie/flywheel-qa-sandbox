<!--
FLY-1356 B-arm variant (skill_framework_mode=matt). Byte-identical to
designer-executor.md EXCEPT the two bare-name brainstorm-skill references now
point to `grilling` (the matt-skills brainstorm-analogue). Semantic deviation,
noted deliberately: `grilling` is an interrogation/stress-test skill, not a
divergent-ideation skill — that difference is part of what the B arm measures.
-->
---
...
surface you're redesigning. Use `grilling`. Surface assumptions explicitly.
...
| When you are… | Invoke |
|---|---|
| Clarifying what to design + product context | `grilling` |
